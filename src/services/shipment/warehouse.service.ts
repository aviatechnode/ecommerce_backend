...
import {
  ...
  type CreateWarehouseLGAInput,
  type WarehouseLGAUniqueInput,
...
export class WarehouseService {
  ...
  static async createWarehouse(
    ...
    const parsed =
      createWarehouseSchema.parse(data);
    ...
    if (existing) {
      throw new Error(
        "Warehouse already exists in this city/state"
      );
    }
 ...
 // GET ALL WAREHOUSES
  ...
  static async updateWarehouse(
    ...
    const parsedData =
      updateWarehouseSchema.parse(data);
    ...
    if (duplicate) {
      throw new Error(
        "Another warehouse already exists with these details"
      );
    }
  ...
  static async deleteWarehouse(
    ...
    if (
      ...
      throw new Error(
        "Cannot delete warehouse with stock reservations"
      );
    }
  ...
  static async assignLGA(
    ...
    const parsed =
      createWarehouseLGASchema.parse(
        payload
      );
    ...
    const existing =
      await prisma.warehouseLGA.findUnique(
        {
          where: {
            warehouseId_lgaId: {
              warehouseId:
    ...
    if (existing) {
      throw new Error(
        "LGA already assigned to warehouse"
      );
    }

    return prisma.warehouseLGA.create({
      data: {
        warehouseId:
          parsed.warehouseId,
        lgaId: parsed.lgaId,
  ...
  static async supportsLGA(
    ...
    const parsed =
      warehouseLGAUniqueSchema.parse(
        payload
      );
  ...
  static async createRoute(
    ...
    const parsed =
      createWarehouseRouteSchema.parse(
        payload
      );
  ...
  static async updateRoute(
    ...
    const parsedId =
      warehouseRouteIdParamSchema.parse(
        {
          id,
        }
      );
    ...
    const parsedData =
      updateWarehouseRouteSchema.parse(
        payload
      );

    const existing =
      await prisma.warehouseRoute.findUnique(
        {
          where: {
            id: parsedId.id,
          },
  ...
  static async deleteRoute(
    ...
    return prisma.warehouseRoute.delete({
      where: {
        id: parsed.id,
      },
    });
